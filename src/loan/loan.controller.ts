...
export class LoanController {
  ...
  async findAll(@Query() query: LoanQueryDto, @Request() req: any) {
  ...
  async getSummary(@Query() query: LoanSummaryDto, @Request() req: any) {
  ...
  async findOne(@Param('id') id: string, @Request() req: any): Promise<Loan> {
  ...
  @Get('payments')
  @ApiOperation({
    summary: 'Get all loan payments with filters and pagination',
  })
  @ApiResponse({ status: 200, description: 'Payments retrieved successfully' })
  async findPayments(@Query() query: LoanPaymentQueryDto, @Request() req: any) {
  ...
  @ApiResponse({ status: 400, description: 'Bad request' })
  @ApiResponse({ status: 404, description: 'Payment not found' })
  async removePayment(@Param('id') id: string, @Request() req: any): Promise<void> {
